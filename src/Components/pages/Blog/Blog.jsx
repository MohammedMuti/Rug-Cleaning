      ...
      <div className="blogs">
        ...
        <div className="blog content">
          ...
          <BlogComp
            ...
            desc="Description : Professional rug cleaners have their own set of tools and techniques to"
          />
          <BlogComp
            title="Rug cleaning vs Carpet cleaning"
            img={require("../../../Assets/Images/Blogs/versus.jpg")}
            link={"/blog/rug-cleaning-vs-carpet-cleaning"}
            desc="Description : Many people think that Rugs and carpets are the same thing and wash"
          />
          <BlogComp
